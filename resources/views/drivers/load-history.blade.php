...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">{{ __('Drivers/Owners Load History') }}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('/')}}">{{ __('Dashboard') }}</a></li>
              <li class="breadcrumb-item"><a href="{{url('/drivers-owners')}}">{{ __('Drivers/Owners') }}</a></li>
              <li class="breadcrumb-item active">{{ __('Drivers/Owners Load History') }}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
 ...
 <div class="content">
      ...
      <div class="card">
              <div class="card-header">
                <h4>{{ __('Drivers/Owners Load History') }}</h4>
                <form action="{{url('drivers-owners/load-history/'.$params['id'])}}" method="get">
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-3">
